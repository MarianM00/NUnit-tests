...
namespace Loans.Tests
{
    public class LoadRepaymentCalculatorShould
    {
        ...
        public decimal CalculateCorrectMonthlyRepayment_Simpplified(decimal principal, decimal interestRate, int termInYears)
        {
            var sut = new LoanRepaymentCalculator();
        ...
        public void CalculateCorrectMonthlyRepayment_TestData(decimal principal, decimal interestRate, int termInYears, decimal expectedMonthlyPayment)
        {
            var sut = new LoanRepaymentCalculator();
            var monthlyPayment = sut.CalculateMonthlyRepayment(
               new LoanAmount("USD", principal), interestRate, new LoanTerm(termInYears));
